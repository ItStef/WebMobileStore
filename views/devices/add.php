...
<div class="dashboard">
    ...
    <form class="register-form" method="post" enctype="multipart/form-data">
        <label>Name: <input name="name" class="input-wide" required></label>
        <label>Brand: <input name="brand" class="input-wide" required></label>
        <label>OS: <input name="os" class="input-wide" required></label>
